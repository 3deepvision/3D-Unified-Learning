...
from leader_pct import Leader_Point_Transformer_cls

class get_model(nn.Module):
    def __init__(self, num_class=3, normal_channel=False, hidden_dim=64, guidance_dim=0, nheads=4):
        ...
        self.leader_pct = Leader_Point_Transformer_cls(self.num_class, self.hidden_dim, self.guidance_dim, self.nheads)
    ...
    def forward(self, x):
        ...
        return self.leader_pct(x, fusedf1, fusedf2, fusedf3, fusedf4)
