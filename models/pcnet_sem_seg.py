...
from sem_assistingdgcnn import Assist_DGCNN
from leader_pct import Leader_Point_Transformer_semseg
...
class get_model(nn.Module):
    def __init__(self, num_class=3, normal_channel=True, hidden_dim=64, guidance_dim=0, nheads=4):
        ...
        self.leader_pct = Leader_Point_Transformer_semseg(self.num_class, self.hidden_dim, self.guidance_dim, self.nheads)
